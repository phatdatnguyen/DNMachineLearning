...
{
    public partial class RegressionDataControl : UserControl
    {
        // Fields
        ...
        {
            VisualizeRegressionDataDialog visualizeRegressionDataDialog = new VisualizeRegressionDataDialog(dataTable, "Data");
            visualizeRegressionDataDialog.Show(this);
        }

        private void trainingDatasetVisualizeButton_Click(object sender, EventArgs e)
        {
            VisualizeRegressionDataDialog visualizeRegressionDataDialog = new VisualizeRegressionDataDialog(trainingDataTable, "Training dataset");
            visualizeRegressionDataDialog.Show(this);
        }

        private void testDatasetVisualizeButton_Click(object sender, EventArgs e)
        {
            VisualizeRegressionDataDialog visualizeRegressionDataDialog = new VisualizeRegressionDataDialog(testDataTable, "Test dataset");
            visualizeRegressionDataDialog.Show(this);
        }
