...
{
    partial class RegressionDataControl
    {
        /// <summary> 
        ...
        private void InitializeComponent()
        {
            ...
            this.toolTip.SetToolTip(this.testDatasetLoadButton, "- Data must include one or more input columns and one output column.\r\n- Output co" +
        "lumn must be placed at the last position.\r\n- All columns must contain numerical " +
        "data.");
            ...
            this.trainingDatasetHasHeadersCheckBox.TabIndex = 0;
            ...
            this.trainingDatasetLoadButton.TabIndex = 1;
            this.trainingDatasetLoadButton.Text = "Load";
            this.toolTip.SetToolTip(this.trainingDatasetLoadButton, "- Data must include one or more input columns and one output column.\r\n- Output co" +
        "lumn must be placed at the last position.\r\n- All columns must contain numerical " +
        "data.");
            ...
            this.trainingDatasetVisualizeButton.TabIndex = 2;
            ...
            this.toolTip.SetToolTip(this.loadButton, "- Data must include one or more input columns and one output column.\r\n- Output co" +
        "lumn must be placed at the last position.\r\n- All columns must contain numerical " +
        "data.");
